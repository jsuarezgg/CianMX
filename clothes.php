            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="clothes.php">Prendas</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td class="remove-pr">
                                        <form method="post" action = 'php/delete_item.php'>
                                            <input type="hidden" name="id_delete" value="<?php echo $row1[0];?>">
                                            <input type="hidden" name="table_delete" value="prendas">
                    ...
                    <div class="row my-5">
                        ...
                        <div class="col-12 d-flex shopping-box"><a href="add_clothes.html" class="ml-auto btn hvr-hover">Agregar Prendas</a> </div>
                    </div>
                </div>
            </div>
        </div>
