...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="finance.php">Finanzas</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    $query2 = "
            SELECT COUNT(prendas.precio), SUM(prendas.precio) FROM
            pedidos  INNER JOIN prendas ON (pedidos.id_prenda = prendas.id_prenda)
            ";
    $result2 = $conn->query($query2);

    $query3 = "SELECT SUM(monto_pesos) FROM gastos";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row my-5">
                        <div class="col-lg-8 col-sm-12"><h2 style="float: right">AGREGAR GASTO</h2></div>

                        <form name="clothes_form" method="post" action="php/gasto.php">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="monto" name="monto" placeholder="Monto" required data-error="Por favor ingresa el monto">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                <div class="submit-button text-center">
                                    <button class="btn hvr-hover" type="submit" name="submit" id="submit" value="submit">Agregar Gasto</button>
                                    <div id="gastoSubmit" class="h3 text-center hidden"></div>
                        ...
                        <table id="example" class="table" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Monto total de las Ordenes</th>
                                </tr>
                            </thead>
                            <tbody>
